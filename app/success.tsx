        ...
        <SafeAreaView className="flex-1 bg-[#050505] items-center justify-center px-6">
            ...
            <View className="items-center w-full">
                ...
                <Text className="text-gray-400 text-base text-center mb-12 leading-6">
                    Your account has been created successfully. Please verify your identity to start stream!
                </Text>
                ...
                >
                    <Text className="text-white text-lg font-semibold">Start Watching</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
